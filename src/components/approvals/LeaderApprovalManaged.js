...
class LeaderApprovalManaged extends React.Component {
    ...
    onSubmit = (value) => {
        ...
        checkrequest.leaderresponse = this.state.response;
        checkrequest.leaderresponsedate = new Date();
        checkrequest.leaderstatus = value;
        checkrequest.leaderapprover = this.props.username;
        ...
        this.props.submitLeaderResponse(body)
            .then(() => {
            ...
            <div>
                <div hidden={this.state.submitted}>
                    ...
                    <div style={{ padding: "20px" }}>
                        ...
                        <div className="row">
                            <div className="col-md-8">
                                <label><b>Leader Approval Response:</b></label>
